...
/**
 * Tests XForms test suite test 3.2.3.f.xhtml.
 **/
public class XF11_3_2_3_f_Test extends BaseWebTest {
	...
	public String getFormURL() {
		return getBaseURL()
				+ "/xforms-test-suite/forms/XForms1.1/Edition1/Chapt03/3.2/3.2.3/3.2.3.f.xhtml";
	}
}
