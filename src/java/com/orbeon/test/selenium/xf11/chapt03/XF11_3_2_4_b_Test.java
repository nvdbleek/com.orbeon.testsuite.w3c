...
/**
 * Tests XForms test suite test 3.2.4.b.xhtml.
 **/
public class XF11_3_2_4_b_Test extends BaseWebTest {

	public void test_3_2_4_b() throws Exception {
		openFormURL();
		assertEquals(
				"Orbeon Forms Example Applications - 3.2.4.b node-set binding - model attribute of itemset element",
				selenium.getTitle());
		...
		assertTrue(selenium.isTextPresent("Audi"));
	...
	public String getFormURL() {
		return getBaseURL()
				+ "/xforms-test-suite/forms/XForms1.1/Edition1/Chapt03/3.2/3.2.4/3.2.4.b.xhtml";
	}
}
