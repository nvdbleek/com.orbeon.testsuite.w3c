...
/**
 * Tests XForms test suite test 7.8.3.b.xhtml.
 **/
public class XF11_7_8_3_b_Test extends BaseWebTest {

	public void test_7_8_3_b() throws Exception {
		openFormURL();
		assertEquals(
				"Orbeon Forms Example Applications - 7.8.3.b digest() function using sha384 and sha512 (non-normative)",
				selenium.getTitle());
	...
	public String getFormURL() {
		return getBaseURL()
				+ "/xforms-test-suite/forms/XForms1.1/Edition1/Chapt07/7.8/7.8.3/7.8.3.b.xhtml";
	}
}
